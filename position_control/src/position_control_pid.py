	...
	def control_exe(id_aruco):
		...
		for each_coord in all_waypoints_list[id_aruco][0]:
			...
			while ( dist(a_point,each_coord) > 10 ):
				os.system('clear')
				print('control:' ,id_aruco)
				#print(quit_flag_worker)
				
				#CONTROL OF ORIENTATION
				#print(each_coord)
				#print("follow?")
				velocidad_cte=600 #unidades? #300 P=0.1 D=0.001
#				print("angulo_deseado_grados:",angulo_deseado_grados)
#				print("error:",error)
#				print("angulo aruco mapa2d:",angulo_actual)
#				print('#####')
#				print("angulo_deseado_grados_360:",angulo_deseado_grados_360)
#				print("error_360:",error_360)
#				print("angulo aruco 360:",angulo_actual_360)
				print('###########')
				print(cual)
